...
private:
    void hand_pose_callback(const geometry_msgs::msg::PoseArray::SharedPtr msg)
    {
        ...
        Eigen::Vector3d arm_position = vr_position + transform_zedm_to_arm_;
        
        // For orientation, we keep the VR orientation as-is for now
        // You may need to apply additional rotation transformations depending on
        // the coordinate frame conventions of your VR system vs robot
        Eigen::Quaterniond arm_quaternion = vr_quaternion;
