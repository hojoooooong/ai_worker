#ifndef FFW_KINEMATICS__HAND_IK_SOLVER_HPP
#define FFW_KINEMATICS__HAND_IK_SOLVER_HPP

#include <ffw_kinematics/position_only_ik_vel_solver.hpp>
...
#endif // FFW_KINEMATICS__HAND_IK_SOLVER_HPP