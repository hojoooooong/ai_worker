#ifndef FFW_KINEMATICS__POSITION_ONLY_IK_VEL_SOLVER_HPP
#define FFW_KINEMATICS__POSITION_ONLY_IK_VEL_SOLVER_HPP
...
#endif // FFW_KINEMATICS__POSITION_ONLY_IK_VEL_SOLVER_HPP