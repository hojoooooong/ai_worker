...
def generate_launch_description():
    ...
    vr_squeeze_closed = LaunchConfiguration('vr_squeeze_closed')
    vr_squeeze_open = LaunchConfiguration('vr_squeeze_open')
    gripper_pos_closed = LaunchConfiguration('gripper_pos_closed')
    gripper_pos_open = LaunchConfiguration('gripper_pos_open')
    ...
    ld.add_action(DeclareLaunchArgument('right_ik_solution_topic', default_value='/right_arm_ik_solution'))
    ld.add_action(DeclareLaunchArgument('left_ik_solution_topic', default_value='/left_arm_ik_solution'))
    ...
    # Gripper parameters
    ld.add_action(DeclareLaunchArgument('trajectory_duration', default_value='0.01'))
    ld.add_action(DeclareLaunchArgument('vr_squeeze_closed', default_value='0.035'))
    ld.add_action(DeclareLaunchArgument('vr_squeeze_open', default_value='0.095'))
    ld.add_action(DeclareLaunchArgument('gripper_pos_closed', default_value='1.2'))
    ld.add_action(DeclareLaunchArgument('gripper_pos_open', default_value='0.0'))
    ...
    gripper_controller_node = Node(
        ...
        parameters=[{
            ...
            'vr_squeeze_closed': vr_squeeze_closed,
            'vr_squeeze_open': vr_squeeze_open,
            'gripper_pos_closed': gripper_pos_closed,
            'gripper_pos_open': gripper_pos_open,
        }],
        remappings=[
            ('/right_arm_ik_solution', '/right_arm_ik_solution'),
            ('/left_arm_ik_solution', '/left_arm_ik_solution'),
            ('/vr_hand/left_squeeze', '/vr_hand/left_squeeze'),
            ('/vr_hand/right_squeeze', '/vr_hand/right_squeeze'),
            ('/leader/joint_trajectory_command_broadcaster_right/joint_trajectory', '/leader/joint_trajectory_command_broadcaster_right/joint_trajectory'),
            ('/leader/joint_trajectory_command_broadcaster_left/joint_trajectory', '/leader/joint_trajectory_command_broadcaster_left/joint_trajectory'),
        ]
    )
