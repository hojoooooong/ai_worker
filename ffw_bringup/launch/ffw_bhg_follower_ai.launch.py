...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument('model', default_value='ffw_bhg_follower',
    ...
    controller_manager_config = PathJoinSubstitution([
        ...
        'ffw_bhg_follower_ai_hardware_controller.yaml'
    ])
    ...
    trajectory_params_file = PathJoinSubstitution([
        ...
        'config',
        model,
        'ffw_bhg_follower_initial_positions.yaml',
    ])
