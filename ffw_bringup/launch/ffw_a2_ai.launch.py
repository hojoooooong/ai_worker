...
def generate_launch_description():
    declared_arguments = [
        DeclareLaunchArgument(
            'description_file',
            default_value='ffw_a2.urdf.xacro',
    ...
    robot_controllers = PathJoinSubstitution(
        [
            ...
            'config',
            'ffw_a2',
            'ffw_a2_ai_hardware_controller.yaml',
        ]
    )
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare('ffw_description'), 'urdf', 'ffw_a2', description_file]
            ),
            ' ',
    ...
    robot_state_publisher_node = Node(
        ...
        output='both',
        parameters=[robot_description, {'frame_prefix': 'a2_'}],
    )
